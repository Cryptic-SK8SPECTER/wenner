    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Erro ao sair! Tente novamente.');
        case 11:
        case "end":
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"forgot-password.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Requisição feita com sucesso, verifique o seu emal!');
            window.setTimeout(function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Acessório cadastrado com sucesso!');
          }
          _context.next = 10;
          break;
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Produto excluído com sucesso!');

            // Remover a linha da tabela correspondente ao produto excluído
            row = document.querySelector("a[data-productlist-id=\"".concat(productId, "\"]")).closest('tr');
            row.remove();
          }
          _context2.next = 11;
          break;
        case 7:
          ...
          _context2.t0 = _context2["catch"](0);
          console.log(_context2.t0.response);
          (0, _alerts.showAlert)('error', 'Erro ao excluir produto! Tente novamente.');
        case 11:
        case "end":
          return _context2.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Cadastrado com sucesso!");
          }
          _context2.next = 10;
          break;
        case 7:
...
exports.singupuser = exports.deleteUser = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var singupuser = exports.singupuser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, contact, address, birthDate, password, passwordConfirm) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') (0, _alerts.showAlert)('success', 'cadastrado com sucesso!');
          _context.next = 10;
          break;
        case 7:
          _context.prev = 7;
  ...
  return function singupuser(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Cliente excluído com sucesso!');

            // Remover a linha da tabela correspondente ao cliente excluído
            row = document.querySelector("a[data-user-id=\"".concat(customerId, "\"]")).closest('tr');
            row.remove();
          }
          _context2.next = 11;
          break;
        case 7:
          ...
          _context2.t0 = _context2["catch"](0);
          console.log(_context2.t0.response);
          (0, _alerts.showAlert)('error', 'Erro ao excluir cliente! Tente novamente.');
        case 11:
        case "end":
          return _context2.stop();
      }
...
exports.updateCartQuantity = exports.getMyCart = exports.deleteFromProduct = exports.addToCart = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Acessório adicionado no carinho');
          }
          _context.next = 10;
          break;
        case 7:
...
var deleteFromProduct = exports.deleteFromProduct = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Acessório eliminado do carinho');
            setTimeout(function () {
  ...
  return function deleteFromProduct(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();
var updateCartQuantity = exports.updateCartQuantity = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          res = _context4.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Carrinho atualizado com sucesso!');
            setTimeout(function () {
              window.location.reload();
            }, 1000);
          }
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Erro ao atualizar o carrinho. Tente novamente.');
        case 10:
        case "end":
  ...
  return function updateCartQuantity(_x5, _x6) {
...
exports.purchaseProduct = exports.deleteOrder = exports.createOrder = exports.confirmOrder = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Ecomenda confirmada com sucesso');
            setTimeout(function () {
              window.location.reload();
            }, 1000);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Ecomenda criada com sucesso');
            setTimeout(function () {
              window.location.reload();
            }, 1000);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Ecomenda eliminada com sucesso');
            setTimeout(function () {
              window.location.reload();
            }, 1000);
          }
...
var purchaseProduct = exports.purchaseProduct = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          res = _context4.sent;
          if (res.status === 200) {
            (0, _alerts.showAlert)('success', 'Compra realizada com sucesso!');
            setTimeout(function () {
              window.location.reload();
            }, 1000);
          }
  ...
  return function purchaseProduct(_x3, _x4) {
    return _ref4.apply(this, arguments);
  };
}();
...
var logOutBtns = document.querySelectorAll('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var signupForm = document.querySelector('.form-signup-user-data');
var cartForm = document.querySelector('.add-to-cart');
var onClickChebout = document.querySelector('.checkout');
var btnCreateOrder = document.querySelector('.btn-create-order');
...
var deleteBtns = document.querySelectorAll('.btn-delete-product');
var deleteOrderBtns = document.querySelectorAll('.btn-order-list');
var confirmOrderBtns = document.querySelectorAll('.btn-confirm-order');
var deleteUserBtns = document.querySelectorAll('.btn-delete-user');
var buyBtns = document.querySelectorAll('.buy-btn');
var productSubmitForm = document.getElementById('submitAll');
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              formData = new FormData(); // Coleta os dados do primeiro formulário
              form1 = document.querySelector('.form-product-data-part-I');
              if (form1) {
                formData.append('imageCover', document.getElementById('imageCover').files[0]);
                formData.append('name', form1.querySelector('#name').value);
                formData.append('description', form1.querySelector('#description').value);
                formData.append('stockQuantity', form1.querySelector('#stockQuantity').value);
              ...
              if (form2) {
                ...
                formData.append('statusDiscount', form2.querySelector('#statusDiscountSelect').value);
                priceDiscount = form2.querySelector('#priceDiscount').value;
                if (priceDiscount) {
                  formData.append('priceDiscount', priceDiscount);
                }
                selectedColors = JSON.parse(form2.querySelector('#selectedColorsInput').value);
                formData.append('colors', selectedColors);
              }

              // Coleta os arquivos carregados no Uppy
              form3 = document.getElementById('pc-uppy-1');
              if (form3 && window.uppy1) {
                uppyFiles = window.uppy1.getFiles(); // Use a instância global
                uppyFiles.forEach(function (file) {
              ...
              formData.forEach(function (value, key) {
                if (value instanceof File) {
                  console.log("".concat(key, ": ").concat(value.name, " (").concat(value.type, ", ").concat(value.size, " bytes)"));
                } else {
              ...
              _context.next = 11;
              return (0, _product.addNewProduct)(formData);
            case 11:
            case "end":
              return _context.stop();
          }
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          document.querySelector('.btn--save-password').textContent = 'Atualizar Senha';
...
if (cartForm) cartForm.addEventListener('submit', function (e) {
  ...
  (0, _cart.addToCart)(product, quantity);
});
if (onClickChebout) {
  onClickChebout.addEventListener('click', function (e) {
    (0, _cart.getMyCart)();
  });
}
if (deleteFromCart) {
  deleteFromCart.forEach(function (button) {
    button.addEventListener('click', function (e) {
      e.preventDefault();
      var cartId = button.getAttribute('data-cart-id');
      var productId = button.getAttribute('data-product-id');
      console.log('os ids ', cartId, ' ', productId);
      (0, _cart.deleteFromProduct)(cartId, productId);
    });
  });
}
if (decreaseBtns) {
  ...
  decreaseBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var productId = e.target.closest('button').getAttribute('data-product-id');
      var input = e.target.closest('.btn-group').querySelector('input');
      ...
      (0, _cart.updateCartQuantity)(productId, quantity);
    });
  });
}
if (increaseBtns) {
...
if (deleteBtns) {
  deleteBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var productId = e.target.closest('a').getAttribute('data-productlist-id');
      console.log('Product ID:', productId); // Verifique o ID do produto no console
      (0, _product.deleteProduct)(productId);
    });
  });
}
if (deleteOrderBtns) {
  deleteOrderBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var orderId = e.target.closest('a').getAttribute('data-orderlist-id');
      (0, _order.deleteOrder)(orderId);
    });
  });
}
if (confirmOrderBtns) {
  confirmOrderBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var orderId = e.target.closest('a').getAttribute('data-order-id');
      (0, _order.confirmOrder)(orderId);
    });
  });
}
if (deleteUserBtns) {
  deleteUserBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var customerId = e.target.closest('a').getAttribute('data-user-id');
      console.log('Customer ID:', customerId);
      (0, _user.deleteUser)(customerId);
    });
  });
}
if (btnCreateOrder) {
...
if (buyBtns.length > 0) {
  buyBtns.forEach(function (buyBtn) {
    buyBtn.addEventListener('click', function (e) {
      ...
      var quantity = document.getElementById('number').value;
      var product = document.getElementById('productId').value;
      (0, _order.purchaseProduct)(product, quantity);
    });
  });
}
},{"./login":"login.js","./forgot-password":"forgot-password.js","./product":"product.js","./updateSettings":"updateSettings.js","./user":"user.js","./cart":"cart.js","./order":"order.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "64824" + '/');
