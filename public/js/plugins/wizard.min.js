      ...
      },
      {
        ...
        value: function() {
          ...
          this.prevBtn &&
            ...
            this.firstBtn &&
              this.firstBtn.addEventListener('click', function(t) {
                t.preventDefault(),
                  0 !== s.selectedIndex &&
                    s.validateForm() &&
                    ((s.selectedIndex = 0), s.showTabSelectedTab());
              }),
            this.lastBtn &&
              this.lastBtn.addEventListener('click', function(t) {
                t.preventDefault(),
                  s.selectedIndex !== s.navItems.length - 1 &&
                    s.validateForm() &&
                    ((s.selectedIndex = s.navItems.length - 1),
          ...
          new bootstrap.Tab(this.navItems[this.selectedIndex]).show(),
            this.progressBar &&
              (this.progressBar.style.width =
                (
                  ((this.selectedIndex + 1) / this.navItems.length) *
                  100
                ).toString() + '%'),
            this.changeBtnStyle();
        }
