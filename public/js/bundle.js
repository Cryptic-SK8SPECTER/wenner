...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51Pp8G5ELANxytM8gotNOPJhtWFR4C4FovvUe7lvd7NTwZ1lL8VebOqRYoXPgIzHlsuhPDJbXqD0X1UrzYkEUQql300Y3PGVKbE');
...
var userSignUpDataForm = document.querySelector('.form-sign-up--data');
...
if (logOutBtn) {
  logOutBtn.addEventListener('click', function () {
    console.log('Botão de logout clicado'); // Deve aparecer no console quando o botão for clicado
    (0, _login.logout)();
  });
}
...
if (userSignUpDataForm) userSignUpDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('name').value;
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  var passwordConfirm = document.getElementById('passwordConfirm').value;
  (0, _updateSettings.uploadUserData)(name, email, password, passwordConfirm);
});
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "31693" + '/');
